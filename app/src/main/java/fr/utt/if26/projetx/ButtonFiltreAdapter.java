...
public class ButtonFiltreAdapter extends BaseAdapter implements ListAdapter {
    private List<Filtre> list;
    private Context context;
    private String from;
    private String to;

    public ButtonFiltreAdapter(List<Filtre> list, Context context, String from, String to) {
        this.list = list;
